...
@section('title', 'Story Frame')

@section('breadcrumbs', 'Halaman Story Frame')
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-5 text-right">
                        <a href="{{ route('destinations.create') }}" class="btn btn-sm btn-success"> <i class="fa fa-plus"></i>
                            Create</a>
                    </div>
                            ...
                            <ul class="nav nav-tabs ">
                                <li class="nav-item">
                                    <a class="nav-link p-2 px-3 {{ Request::get('status') == null ? 'active' : '' }}"
                                        href="{{ route('destinations.index') }}">All</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link p-2 px-3 {{ Request::get('status') == 'publish' ? 'active' : '' }}"
                                        href="{{ route('destinations.index', ['status' => 'publish']) }}">Publish</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link p-2 px-3 {{ Request::get('status') == 'draft' ? 'active' : '' }}"
                                        href="{{ route('destinations.index', ['status' => 'draft']) }}">Draft</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-sm-5">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-sm btn-danger"
                                            onclick="deleteConfirm('{{ $destination->id }}', '{{ $destination->title }}')"
                                            data-target="#modalDelete" data-toggle="modal"><i
