...
<body>
    ...
    <header id="header">
        <div class="container">
            ...
            <div id="logo" class="pull-left">
                <a href="#hero">
                    <img src="{{ asset('user/images/icon.png') }}"
                        style="margin-right:5px; border: 2px solid white; border-radius: 8px; background-color: white; position: relative; top: -10px;"
                        class="logo-bordered" /></img>
                    <h2 class="d-inline text-light">Jait Oya</h2>
                </a>
            </div>
  ...
  ============================-->
    <footer id="footer">
        ...
        <div class="container">
            <div class="copyright">
                &copy; Copyright <strong>Rendy Ready</strong>.
            </div>
            {{-- <div class="credits">
